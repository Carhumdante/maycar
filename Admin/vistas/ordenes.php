		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Añadir Orden</span></a>
		...
		<div class="modal-content">
			<form>
				<div class="modal-header">						
					<h4 class="modal-title">Añadir Ordenes</h4>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form>
				...
				<div class="modal-body">					
					<p>Estas seguro de eliminar esta Orden?</p>
