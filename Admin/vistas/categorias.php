			...
			<table class="table table-striped table-hover">
				...
				<tbody>
                    <tr>    
						...
						<td>1</td>
						<td>Maquillaje</td>
						<td>Seccion de produscos para maquillarse</td>
						<td>
                    ...
                    <tr>    
						...
						<td>2</td>
						<td>Tratamientos</td>
						<td>Sección de productos para el tratamientos de cara, manos, etc.</td>
						<td>
							<a href="#editEmployeeModal" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Editar">&#xE254;</i></a>
							<a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Eliminar">&#xE872;</i></a>
						</td>
                    ...
                    <tr>    
						...
						<td>3</td>
						<td>Colorimetría</td>
						<td>Sección para tintes de cabello.</td>
						<td>
							<a href="#editEmployeeModal" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Editar">&#xE254;</i></a>
							<a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Eliminar">&#xE872;</i></a>
						</td>
                    ...
                    <tr>    
						...
						<td>4</td>
						<td>Accesorios</td>
						<td>Sección de productos, como broches, pulseras, cadenas, gomas, donas, etc.</td>
						<td>
							<a href="#editEmployeeModal" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Editar">&#xE254;</i></a>
							<a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Eliminar">&#xE872;</i></a>
						</td>
